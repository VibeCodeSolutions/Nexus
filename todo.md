...
- [ ] **JJ-A1-COD** — Refresh-Button + sichtbarer Error
...
- [ ] **JJ-A2-COD** — Diag-Zeitstempel zurückschreiben
...
- [ ] **JJ-A3-COD** — Optimistic-Insert + Sanity-Check für Tasks
...
- [ ] **JJ-B1-DBG** — Repro fixieren auf Kais Setup
...
- [ ] **JJ-B3-DOC** — `docs/SYNC.md` (neu, JJ-PR-002)
...
- [ ] **JJ-C1-COD** — Core: Provider-Settings-Endpoints (Bearer-pflichtig, JJ-PR-003)
...
- [ ] **JJ-C2-COD** — Android: LLM-Konfigurationsblock im Settings-Screen
...
- [ ] **JJ-C3-COD** — Android: "Wizard neustarten"-Button
...
- [ ] **JJ-C4-COD** — Desktop: Settings-Modal + Wizard bei Erststart
...
- [ ] **JJ-D1-COD** — `recategorize_unsorted_inner` extrahieren + Limit (JJ-PR-004 / N-006-PER)
...
- [ ] **JJ-D2-COD** — Background-Task im Server + Single-Core-Garant (JJ-PR-005)
...
- [ ] **JJ-D3-COD** — `GET /braindump/unsorted/count`
...
- [ ] **JJ-D4-COD** — UI: Unsorted-Badge beide Devices
...
- [ ] **JJ-F1-TST** — Automatisierte Tests
...
- [ ] **JJ-E1-DOC** — `docs/VAULT-DESIGN.md` (neu)
...
- [ ] **JJ-GATE-0** — Plan-Review durch Tuvok + Seven
